...
BugsyGroup:
	...
	db 30, FEAROW,     DRILL_PECK, NO_MOVE, NO_MOVE, NO_MOVE
	db 38, KABUTOPS,   WATERFALL, ROCK_SLIDE, HARDEN, NO_MOVE
	db 38, PINSIR,     VICEGRIP, ROCK_SLIDE, SUBMISSION, NO_MOVE
	db 38, VICTREEBEL, ACID, SLUDGE_BOMB, SLEEP_POWDER, RAZOR_LEAF
	db 40, SCYTHER,    QUICK_ATTACK, GUILLOTINE, STEEL_WING, SWORDS_DANCE
	db -1 ; end
